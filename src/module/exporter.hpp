...
public:
	...
	static std::string get_output_map_name() { return output_map_name; }
	static const char* fix_map_name(const char* name, utils::memory::allocator& allocator);
	static bool map_must_be_renamed() { return must_be_renamed; };
...
private:
	...
	static std::string output_map_name;
	static bool must_be_renamed;
