...
#pragma pack(pop)
		...
		enum ShaderCodeConstants
		{
			...
			CONST_SRC_CODE_PIXEL_COST_FRACS = 0xC,
			CONST_SRC_CODE_PIXEL_COST_DECODE = 0xD,
			CONST_SRC_CODE_FILTER_TAP_0 = 0xE,
			CONST_SRC_CODE_FILTER_TAP_1 = 0xF,
			CONST_SRC_CODE_FILTER_TAP_2 = 0x10,
			CONST_SRC_CODE_FILTER_TAP_3 = 0x11,
			CONST_SRC_CODE_FILTER_TAP_4 = 0x12,
			CONST_SRC_CODE_FILTER_TAP_5 = 0x13,
			CONST_SRC_CODE_FILTER_TAP_6 = 0x14,
			CONST_SRC_CODE_FILTER_TAP_7 = 0x15,
			CONST_SRC_CODE_COLOR_MATRIX_R = 0x16,
			CONST_SRC_CODE_COLOR_MATRIX_G = 0x17,
			CONST_SRC_CODE_COLOR_MATRIX_B = 0x18,
			CONST_SRC_CODE_RENDER_TARGET_SIZE = 0x19,
			CONST_SRC_CODE_RENDER_SOURCE_SIZE = 0x1A,
			CONST_SRC_CODE_ALWAYS_DIRTY_PS_END = 0x1B,
			CONST_SRC_CODE_FIXED_PS_BEGIN = 0x1B,
			CONST_SRC_CODE_DOF_EQUATION_VIEWMODEL_AND_FAR_BLUR = 0x1B,
			CONST_SRC_CODE_DOF_EQUATION_SCENE = 0x1C,
			CONST_SRC_CODE_DOF_LERP_SCALE = 0x1D,
			CONST_SRC_CODE_DOF_LERP_BIAS = 0x1E,
			CONST_SRC_CODE_DOF_ROW_DELTA = 0x1F,
			CONST_SRC_CODE_MOTION_MATRIX_X = 0x20,
			CONST_SRC_CODE_MOTION_MATRIX_Y = 0x21,
			CONST_SRC_CODE_MOTION_MATRIX_W = 0x22,
			CONST_SRC_CODE_SHADOWMAP_SWITCH_PARTITION = 0x23,
			CONST_SRC_CODE_SHADOWMAP_SCALE = 0x24,
			CONST_SRC_CODE_ZNEAR = 0x25,
			...
			CONST_SRC_CODE_FOG_COLOR_LINEAR = 0x2A,
			CONST_SRC_CODE_FOG_COLOR_GAMMA = 0x2B,
			CONST_SRC_CODE_FOG_SUN_CONSTS = 0x2C,
			CONST_SRC_CODE_FOG_SUN_COLOR_LINEAR = 0x2D,
			CONST_SRC_CODE_FOG_SUN_COLOR_GAMMA = 0x2E,
			CONST_SRC_CODE_FOG_SUN_DIR = 0x2F,
			CONST_SRC_CODE_GLOW_SETUP = 0x30,
			CONST_SRC_CODE_GLOW_APPLY = 0x31,
			CONST_SRC_CODE_COLOR_BIAS = 0x32,
			CONST_SRC_CODE_COLOR_TINT_BASE = 0x33,
			CONST_SRC_CODE_COLOR_TINT_DELTA = 0x34,
			CONST_SRC_CODE_COLOR_TINT_QUADRATIC_DELTA = 0x35,
			CONST_SRC_CODE_OUTDOOR_FEATHER_PARMS = 0x36,
			CONST_SRC_CODE_ENVMAP_PARMS = 0x37,
			CONST_SRC_CODE_SUN_SHADOWMAP_PIXEL_ADJUST = 0x38,
			CONST_SRC_CODE_SPOT_SHADOWMAP_PIXEL_ADJUST = 0x39,
			CONST_SRC_CODE_COMPOSITE_FX_DISTORTION = 0x3A,
			CONST_SRC_CODE_POSTFX_FADE_EFFECT = 0x3B,
			CONST_SRC_CODE_VIEWPORT_DIMENSIONS = 0x3C,
			CONST_SRC_CODE_FRAMEBUFFER_READ = 0x3D,
			CONST_SRC_CODE_THERMAL_COLOR_OFFSET = 0x3E,
			CONST_SRC_CODE_PLAYLIST_POPULATION_PARAMS = 0x3F,
			CONST_SRC_CODE_FIXED_PS_END = 0x40,
			CONST_SRC_CODE_NON_PS_BEGIN = 0x40,
			CONST_SRC_CODE_BASE_LIGHTING_COORDS = 0x40,
			CONST_SRC_CODE_LIGHT_PROBE_AMBIENT = 0x41,
			CONST_SRC_CODE_NEARPLANE_ORG = 0x42,
			CONST_SRC_CODE_NEARPLANE_DX = 0x43,
			CONST_SRC_CODE_NEARPLANE_DY = 0x44,
			CONST_SRC_CODE_CLIP_SPACE_LOOKUP_SCALE = 0x45,
			CONST_SRC_CODE_CLIP_SPACE_LOOKUP_OFFSET = 0x46,
			CONST_SRC_CODE_PARTICLE_CLOUD_MATRIX0 = 0x47,
			CONST_SRC_CODE_PARTICLE_CLOUD_MATRIX1 = 0x48,
			CONST_SRC_CODE_PARTICLE_CLOUD_MATRIX2 = 0x49,
			CONST_SRC_CODE_PARTICLE_CLOUD_SPARK_COLOR0 = 0x4A,
			CONST_SRC_CODE_PARTICLE_CLOUD_SPARK_COLOR1 = 0x4B,
			CONST_SRC_CODE_PARTICLE_CLOUD_SPARK_COLOR2 = 0x4C,
			CONST_SRC_CODE_PARTICLE_FOUNTAIN_PARM0 = 0x4D,
			CONST_SRC_CODE_PARTICLE_FOUNTAIN_PARM1 = 0x4E,
			CONST_SRC_CODE_DEPTH_FROM_CLIP = 0x4F,
			CONST_SRC_CODE_CODE_MESH_ARG_0 = 0x50,
			CONST_SRC_CODE_CODE_MESH_ARG_1 = 0x51,
			CONST_SRC_CODE_CODE_MESH_ARG_LAST = 0x51,
			CONST_SRC_CODE_NON_PS_END = 0x52,
			CONST_SRC_CODE_COUNT_FLOAT4 = 0x52,
			CONST_SRC_FIRST_CODE_MATRIX = 0x52,
			CONST_SRC_CODE_VIEW_MATRIX = 0x52,
			CONST_SRC_CODE_INVERSE_VIEW_MATRIX = 0x53,
			CONST_SRC_CODE_TRANSPOSE_VIEW_MATRIX = 0x54,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_VIEW_MATRIX = 0x55,
			CONST_SRC_CODE_PROJECTION_MATRIX = 0x56,
			CONST_SRC_CODE_INVERSE_PROJECTION_MATRIX = 0x57,
			CONST_SRC_CODE_TRANSPOSE_PROJECTION_MATRIX = 0x58,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_PROJECTION_MATRIX = 0x59,
			CONST_SRC_CODE_VIEW_PROJECTION_MATRIX = 0x5A,
			CONST_SRC_CODE_INVERSE_VIEW_PROJECTION_MATRIX = 0x5B,
			CONST_SRC_CODE_TRANSPOSE_VIEW_PROJECTION_MATRIX = 0x5C,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_VIEW_PROJECTION_MATRIX = 0x5D,
			CONST_SRC_CODE_SHADOW_LOOKUP_MATRIX = 0x5E,
			CONST_SRC_CODE_INVERSE_SHADOW_LOOKUP_MATRIX = 0x5F,
			CONST_SRC_CODE_TRANSPOSE_SHADOW_LOOKUP_MATRIX = 0x60,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_SHADOW_LOOKUP_MATRIX = 0x61,
			CONST_SRC_CODE_WORLD_OUTDOOR_LOOKUP_MATRIX = 0x62,
			CONST_SRC_CODE_INVERSE_WORLD_OUTDOOR_LOOKUP_MATRIX = 0x63,
			CONST_SRC_CODE_TRANSPOSE_WORLD_OUTDOOR_LOOKUP_MATRIX = 0x64,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_OUTDOOR_LOOKUP_MATRIX = 0x65,
			CONST_SRC_CODE_WORLD_MATRIX0 = 0x66,
			CONST_SRC_CODE_INVERSE_WORLD_MATRIX0 = 0x67,
			CONST_SRC_CODE_TRANSPOSE_WORLD_MATRIX0 = 0x68,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_MATRIX0 = 0x69,
			CONST_SRC_CODE_WORLD_VIEW_MATRIX0 = 0x6A,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_MATRIX0 = 0x6B,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_MATRIX0 = 0x6C,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_MATRIX0 = 0x6D,
			CONST_SRC_CODE_WORLD_VIEW_PROJECTION_MATRIX0 = 0x6E,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_PROJECTION_MATRIX0 = 0x6F,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX0 = 0x70,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX0 = 0x71,
			CONST_SRC_CODE_WORLD_MATRIX1 = 0x72,
			CONST_SRC_CODE_INVERSE_WORLD_MATRIX1 = 0x73,
			CONST_SRC_CODE_TRANSPOSE_WORLD_MATRIX1 = 0x74,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_MATRIX1 = 0x75,
			CONST_SRC_CODE_WORLD_VIEW_MATRIX1 = 0x76,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_MATRIX1 = 0x77,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_MATRIX1 = 0x78,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_MATRIX1 = 0x79,
			CONST_SRC_CODE_WORLD_VIEW_PROJECTION_MATRIX1 = 0x7A,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_PROJECTION_MATRIX1 = 0x7B,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX1 = 0x7C,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX1 = 0x7D,
			CONST_SRC_CODE_WORLD_MATRIX2 = 0x7E,
			CONST_SRC_CODE_INVERSE_WORLD_MATRIX2 = 0x7F,
			CONST_SRC_CODE_TRANSPOSE_WORLD_MATRIX2 = 0x80,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_MATRIX2 = 0x81,
			CONST_SRC_CODE_WORLD_VIEW_MATRIX2 = 0x82,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_MATRIX2 = 0x83,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_MATRIX2 = 0x84,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_MATRIX2 = 0x85,
			CONST_SRC_CODE_WORLD_VIEW_PROJECTION_MATRIX2 = 0x86,
			CONST_SRC_CODE_INVERSE_WORLD_VIEW_PROJECTION_MATRIX2 = 0x87,
			CONST_SRC_CODE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX2 = 0x88,
			CONST_SRC_CODE_INVERSE_TRANSPOSE_WORLD_VIEW_PROJECTION_MATRIX2 = 0x89,
			CONST_SRC_TOTAL_COUNT = 0x8A,
			CONST_SRC_NONE = 0x8B,
		};
