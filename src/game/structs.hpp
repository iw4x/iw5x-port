...
#pragma pack(pop)
		...
		static_assert(ShaderCodeConstants::CONST_SRC_CODE_FOG_COLOR_GAMMA == 44U);
		...
		static_assert(ShaderCodeConstants::CONST_SRC_CODE_TRANSPOSE_SHADOW_LOOKUP_MATRIX == 98);
